...
export const environment = {
  ...
  ssoUrl: 'https://uateta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationUrl:
    'https://uateta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationSSOUrl: 'https://uateta-claimsapi.safe-guardproducts.com',
  rrUrl: 'https://clmapi-uateta.sgproductsapis.com/claims-api',
  photoUrl:
