...
export const environment = {
  ...
  ssoUrl: 'https://uatgamma-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationUrl:
    'https://uatgamma-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationSSOUrl: 'https://uatgamma-claimsapi.safe-guardproducts.com',
  rrUrl: 'https://clmapi-uatgamma.sgproductsapis.com/claims-api',
  photoUrl:
