...
export const environment = {
  ...
  ssoUrl: 'https://uatalpha-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationUrl:
    'https://uatalpha-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationSSOUrl: 'https://uatalpha-claimsapi.safe-guardproducts.com',
  rrUrl: 'https://clmapi-uatalpha.sgproductsapis.com/claims-api',
  photoUrl:
