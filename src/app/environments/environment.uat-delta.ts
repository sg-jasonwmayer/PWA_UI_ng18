...
export const environment = {
  ...
  ssoUrl: 'https://uatdelta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationUrl:
    'https://uatdelta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationSSOUrl: 'https://uatdelta-claimsapi.safe-guardproducts.com',
  rrUrl: 'https://uatdelta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  photoUrl:
