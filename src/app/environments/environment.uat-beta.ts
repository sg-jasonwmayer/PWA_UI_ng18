...
export const environment = {
  ...
  ssoUrl: 'https://uatbeta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationUrl:
    'https://uatbeta-claimsapi.safe-guardproducts.com/pwa-claims-api',
  autonationSSOUrl: 'https://uatbeta-claimsapi.safe-guardproducts.com',
  rrUrl: 'https://clmapi-beta.sgproductsapis.com/claims-api',
  photoUrl:
